...
const About = () => {
  const stats = [
    { value: "30+", label: "Godina iskustva", icon: <FaBuilding /> },
          ...
          <div className="flex flex-col lg:flex-row gap-16 items-center">
            ...
            >
              ...
              <p className="text-gray-700 mb-6 text-lg leading-relaxed">
                BOB d.o.o. osnovan 1995. godine u Izačiću, razvio se u vodećeg distributera građevinskih materijala 
